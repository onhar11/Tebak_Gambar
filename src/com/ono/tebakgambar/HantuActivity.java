...
public class HantuActivity extends Activity {
	//deklarasi variabel
		EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_hantu);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "HANTU PENASARAN";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), ImigranActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.hantu, menu);
		return true;
	}
