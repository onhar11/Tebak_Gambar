...
public class GelanggangActivity extends Activity {
	//deklarasi variabel
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_gelanggang);
		//cari komponen edit text
			...
			public void cekJawaban(View v){
				String jawabanBenar = "GELANGGANG GURUN";
				...
				if (jawabanUser.equals(jawabanBenar)){
					...
					Intent i = new Intent (getApplicationContext(), HantuActivity.class);
					startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.gelanggang, menu);
		return true;
	}
