...
public class ImigranActivity extends Activity {
	//deklarasi variabel
			EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_imigran);
		//cari komponen edit text
			...
			public void cekJawaban(View v){
				String jawabanBenar = "IMIGRAN GELAP";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.imigran, menu);
		return true;
	}
