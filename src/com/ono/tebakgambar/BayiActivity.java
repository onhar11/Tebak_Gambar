...
public class BayiActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//cari komponen edit text
			...
			public void cekJawaban(View v){
				String jawabanBenar = "BAYI TENGKUREP";
				...
				if (jawabanUser.equals(jawabanBenar)){
					...
					Intent i = new Intent (getApplicationContext(), BersilatActivity.class);
					startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bayi, menu);
		return true;
	}
