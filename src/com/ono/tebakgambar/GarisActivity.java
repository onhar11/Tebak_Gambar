...
public class GarisActivity extends Activity {
	//deklarasi variabel
	EditText jawabanTxt;
	@Override
	...
	public void cekJawaban(View v){
		String jawabanBenar = "GARIS BAWAH";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), GelanggangActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.garis, menu);
		return true;
	}
