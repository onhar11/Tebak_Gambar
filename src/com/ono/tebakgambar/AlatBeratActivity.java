...
public class AlatBeratActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_alat_berat);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "ALAT BERAT";
		...
		if (jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), BayiActivity.class);
			startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.alat_berat, menu);
		return true;
	}
