...
public class DiborgolActivity extends Activity {
	//deklarasi variabel
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_diborgol);
		//cari komponen edit text
			...
			public void cekJawaban(View v){
				String jawabanBenar = "DIBORGOL SERDADU";
				...
				if (jawabanUser.equals(jawabanBenar)){
					...
					Intent i = new Intent (getApplicationContext(), FaseActivity.class);
					startActivity(i);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.diborgol, menu);
		return true;
	}
